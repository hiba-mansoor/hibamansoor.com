...
const ResumeItem = ({heading, dates, title, secondTitle, subtitle, description}) => (
    <div className="d-flex flex-column flex-lg-row w-100 pb-3">
        <div className={`${!description ? 'w-100' : 'resume-heading-text'} d-flex flex-row flex-lg-column align-items-center align-items-lg-end text-left text-lg-right`}>
        ...
        <div className="d-flex flex-column flex-md-row justify-content-between justify-content-lg-around">
            ...
            <div className="d-flex flex-column pl-0 pl-md-3 pb-3">
                ...
                <p className="mb-1">
                    ...
                    <Divider type='circle' /> CSS{' '}
                    <Divider type='circle' /> Java{' '}
                    <Divider type='circle' /> Python{' '}
                </p>
