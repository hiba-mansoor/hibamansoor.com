    ...
    <Jumbotron className="bg-light-blue mb-0" id="contact">
            <Container>
                ...
                <div className="d-flex flex-column flex-lg-row">
                    ...
                    <Form className="d-flex flex-column w-100" action="mailto:hiba@hibamansoor.com" method="GET" target="_blank">
                        ...
                        <Form.Group controlId="contactSubject">
                            <Form.Control type="text" placeholder="Subject" name="subject" id="subject" />
                        </Form.Group>
                        ...
                        <Button variant="primary" type="submit" className="bg-purple border-0 d-flex flex-row justify-content-center">
                            <p>Submit <span aria-label="email" role="img">📧</span></p><span aria-label="phone" role="img" className="d-block d-lg-none">📲</span><span aria-label="laptop" role="img" className="d-none d-lg-block">💻</span>
                        </Button>
                    </Form>
